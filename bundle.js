...
/***/ function(module, exports, __webpack_require__) {
	...
	var Detail = __webpack_require__(225);
	var Movie = __webpack_require__(226);
	var Music = __webpack_require__(227);
	var Book = __webpack_require__(228);
	var Content = __webpack_require__(229);
	var Login = __webpack_require__(230);
	var Regist = __webpack_require__(231);
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(Route, { path: '/movie', component: Movie }),
					React.createElement(Route, { path: '/music', component: Music }),
					React.createElement(Route, { path: '/book', component: Book }),
					React.createElement(Route, { path: '/content', component: Content }),
					React.createElement(Route, { path: '/login', component: Login }),
					React.createElement(Route, { path: '/regist', component: Regist })
				)
			);
		}
	});
			...
			if (this.state.listbooks.length > 0) {
				...
				for (var i = 0; i < listLen; i++) {
					...
					lst.push(React.createElement(
						'div',
						{ className: 'col-lg-4 text-center one', key: i },
						...
						if (detailUrl === musicsid) {
							if (index === "books") {
								...
								lst.push(React.createElement(
									...
									React.createElement(
										'div',
										{ className: 'detailflex', key: j },
										React.createElement('img', { className: 'img-rounded', src: pro[j].images.large }),
										React.createElement(
											'div',
											{ className: 'right' },
											React.createElement(
									...
									React.createElement(
										'div',
										null,
										React.createElement('textarea', { className: 'form-control', rows: '10', placeholder: '\u8BC4\u8BBA\u3002\u3002\u3002' }),
										React.createElement(
											'button',
								...
								lst.push(React.createElement(
									...
									React.createElement(
										'div',
										{ className: 'detailflex' },
										React.createElement('img', { className: 'imgmusic', src: pro[j].images.large }),
										React.createElement(
											'div',
											{ className: 'right' },
											React.createElement(
		...
		render: function render() {
					...
					for (var i = 0; i < listLen; i++) {
						if (data[i].title.indexOf(inputValue) != -1 || data[i].year.indexOf(inputValue) != -1) {
							...
							lst.push(React.createElement(
								'div',
								{ className: 'col-lg-4 text-center one', key: i },
								React.createElement('img', { className: 'text-center',
			...
			return React.createElement(
				...
				React.createElement(
					'div',
					{ id: 'search' },
					React.createElement('input', { type: 'text', ref: 'inputbox', placeholder: '\u8F93\u5165\u641C\u7D22\u5185\u5BB9' }),
					React.createElement('input', { type: 'submit', ref: 'button', value: '\u641C\u7D22', onClick: this.handerClick })
				),
				React.createElement(
					'div',
					{ className: 'row' },
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                'dd',
	                null,
	                React.createElement('input', { type: 'text', value: this.state.rtitle, onChange: this.textChange })
	            ),
	            React.createElement(
	                'dd',
	                null,
	            ...
	            React.createElement(
	                'dd',
	                null,
	                React.createElement('input', { type: 'button', value: '\u63D0\u4EA4', onClick: this.submit })
	            )
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Login = React.createClass({
		...
		handlerClick: function handlerClick() {
			var data = this.state.list;
			var inputE = this.refs.inputEmail.value;
			var inputP = this.refs.inputPassword.value;
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					'form',
					{ className: 'form-signin', onClick: this.handlerSubmit },
					React.createElement(
						'h2',
					...
					React.createElement(
						'button',
						{ className: 'btn btn-lg btn-primary btn-block', type: 'submit', onClick: this.handlerClick },
						'\u767B\u5F55'
					)
				)
			);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Regist = React.createClass({
		...
		handlerSub: function handlerSub() {

			var inputEmail11 = this.refs.inputEmail1.value;
			var inputPassword11 = this.refs.inputPassword1.value;
			console.log(inputEmail11);
			console.log(inputPassword11);
			$.post("http://www.txyxin.online/bookphp/insert.php", { 'inputEmail': inputEmail11, 'inputPassword': inputPassword11 }, function (data) {
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement('input', { type: 'email', ref: 'inputEmail1', className: 'form-control', placeholder: 'Email address', required: true, autofocus: true }),
					React.createElement(
						'label',
						{ className: 'sr-only' },
						'Password'
					),
					React.createElement('input', { type: 'password', ref: 'inputPassword1', className: 'form-control', placeholder: 'Password1', required: true }),
					React.createElement(
						'div',
						{ className: 'checkbox' },
						React.createElement(
					...
					React.createElement(
						'button',
						{ className: 'btn btn-lg btn-primary btn-block', type: 'submit', onClick: this.handlerSub },
						'\u6CE8\u518C'
					)
				)
			);
